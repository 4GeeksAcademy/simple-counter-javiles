...
export function MyDiv (props) {
    return (
        <>
            <div className="container counter-display rounded">
                <div className="clock-img"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-alarm" viewBox="0 0 16 16">
